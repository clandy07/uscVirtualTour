    ...
    <div className="fixed inset-0 backdrop-blur-md flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg shadow-2xl max-w-4xl w-full max-h-[85vh] overflow-hidden flex flex-col">
        ...
        <div className="bg-gradient-to-r from-red-700 to-yellow-600 text-white px-6 py-4 flex justify-between items-center">
          ...
          <button
            onClick={onClose}
            className="text-white hover:text-gray-200 text-3xl font-light leading-none transition"
            aria-label="Close"
          >
            ×
          </button>
        ...
        <div className="border-t px-6 py-4 bg-gray-50 flex justify-end">
          <button
            onClick={onClose}
            className="px-6 py-2 bg-red-700 text-white rounded-lg hover:bg-red-800 transition font-medium shadow-md hover:shadow-lg"
          >
            Close
          </button>
        </div>
